...
number: 49
title: "An Ode to Jurisprudential Disruption"
date: "2018-08-01"
keywords: ["Ateneo Law Journal foreword", "Angelo Herbosa", "jurisprudential disruption", "Jose Manuel Diokno judicial reforms", "Sedfrey Candelaria Republic v Sereno", "quo warranto", "Marcos v Robredo shading threshold", "Van Dorn to Manalo foreign divorce", "TRAIN 1 tax reform", "online sexual exploitation children", "Data Privacy Act", "AI blockchain internet of things", "Howard Calleja Bongbong Marcos Leni Robredo", "Amparita Sta. Maria women's rights", "Raymond Baguilat WTO article", "Ferdinand Negre Kaufman intellectual property", "Ben Aritao data privacy", "solicitors barristers attorneys", "social engineers legal disruption", "Republic v Sereno return to post question"]
target_audience: ["Lead Editor Angelo Herbosa and the Ateneo Law Journal editorial board", "Law students and young lawyers reading the 2018 Ateneo Law Journal", "Academics and practitioners in the areas covered by the 10 articles (constitutional law, family law, IP, taxation, technology law)", "Scholars interested in the Republic v. Sereno ouster and potential reversal"]
word_count: 1289
has_body: true
...
Written August 1, 2018 as the Foreword to the Ateneo Law Journal at the request of Lead Editor Angelo Francesco F. Herbosa, this piece by CJP advances the 'disruptive symphony' thesis: the volume's 10 apparently disparate articles are united by a single arching theme -- disruption -- with their very disparateness as 'the arching melody itself.' He comments on seven articles: Diokno's ('Now or Never') traces how the justice system was 'robbed of its independence and integrity by an unwanted dictatorship' and offers reform solutions; Candelaria-Balisong on Republic v. Sereno treats it as the Court 'consolidating its power to exact accountability even from its own leader'; Santiago-Pelongco (to be read together with Candelaria-Balisong) dissects the ponencia's 'apparent misuse of a remedy found only in the Rules of Court to undermine a constitutional remedy historically intended as the only method to oust impeachable officials.' CJP's sharpest intervention is his forward-looking question on Sereno: when the Court's composition changes and most incumbents retire, will the decision withstand a petition declaring it void for 'being rendered without due process by a biased majority who apparently had not only prejudged their Chief but in fact conceived the very weapon of quo warranto to oust her?' -- potentially enabling Sereno's return as 'the first woman to head the highest court of the land.' Sta. Maria's foreign divorce article (Van Dorn to Manalo) exposes Article 26 of the Family Code as 'zigzagged by the Supreme Court, in the process succumbing to judicial legislation in the guise of interpretation'; Calleja tackles the Marcos v. Robredo 50%-vs-25% shading threshold; Mata-Perez on TRAIN 1 prompts CJP's sole policy intervention: 'Why is the government raising new revenue streams when infrastructure could be built through PPP agreements?' The technology trio -- WTO (Baguilat), online child exploitation (Aritao-Pangilinan), Data Privacy Act (Pardu-Jacob) -- is praised as examining 'the most disruptive phenomenon of our time: technology,' prompting CJP's call that 'law, lawmakers, magistrates and lawyers must keep pace with the speedy march of science.' He closes by honoring Herbosa's team as future 'topnotch advocates and eminent justices': 'My wish is to live long enough to witness their passage.'

## Notable Anecdotes

### Anecdote 1

The Sereno future-reversal question: 'When the composition of the Court would have changed... will the decision withstand a petition to declare it void on the ground that it was rendered without due process by a biased majority who apparently had not only prejudged their Chief but in fact conceived the very weapon of quo warranto to oust her? If such a time and reversal would ever come, would Maria Lourdes P.A. Sereno be returned to her post with the distinction of being the first woman to head the highest court of the land?'

### Anecdote 2

The PPP counter-question for TRAIN 1: 'Why is the government -- in the guise of pursuing its Build, Build, Build program -- raising new revenue streams when the new infrastructures it desires could be constructed without imposing new taxes through the current Public-Private Partnership (PPP) agreements?' -- CJP's sole policy intervention embedded in an otherwise analytical foreword.

### Anecdote 3

The Diokno-writing-for-Ateneo irony: the first article, by Jose Manuel Diokno (the 'intrepid dean of De La Salle College of Law'), disrupts the existing order by being published in the law journal of rival Ateneo -- the disruption theme embodied in the authorship itself.

### Anecdote 4

The solicitor/barrister observation: 'The Philippines and the United States combined them [solicitors and barristers] into singular attorneys capable of becoming judges, justices, lawmakers and implementers. To them surely belong Herbosa and his team of editors and writers.' -- the closing tribute to the journal's editors.
