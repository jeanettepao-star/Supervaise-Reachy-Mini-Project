...
number: 51
title: "Way to a Happy, Free and Prosperous Society"
date: "2018-10-17"
keywords: ["Dean Joan Largo", "Philippine Association of Law Schools PALS", "writ of prosperity", "clinical education", "Cebu legal audience", "social justice constitutional provisions", "Dean Festin tutelary rules", "Columbia Supreme Court economic rights", "Martin Luther King job income liberty", "Confucius fisherman", "University of San Carlos", "Tess Marie Tan USC dissertation", "Rafael Pangalangan Oxford first prize", "South Africa Argentina Colombia economic rights", "entrepreneurship OFWs", "liberty prosperity twin beacons", "Dean Largo PALS president"]
target_audience: ["Dean Joan S. Largo and the PALS membership (primary audience of the collegial response)", "The 'best and brightest legal minds in Cebu' gathered at the PALS event", "Law deans and professors from across the country attending the PALS meeting", "FLP's USC-based scholars and dissertation participants"]
word_count: 1568
has_body: true
...
Delivered October 17, 2018 in Cebu as a closing response to PALS President Dean Joan S. Largo's lecture on constitutional provisions for social justice and human rights, this speech by CJP takes a complementary rather than contesting stance: Dean Largo focused on enforcing social justice provisions via judicial remedies (citing South Africa, Argentina and Colombia) -- on dole-outs, conditional cash transfers, cheap rice, communal housing; CJP's response moves one level deeper to the structural solution. He cites Martin Luther King's 'If a man does not have a job or an income, he has neither life nor liberty' -- deployed 'not because of his nationality, color, gender or religion' but because 'truth is eternal and transcends sovereignty.' He advances the twin beacons thesis ('humans need both justice and jobs; freedom and food; ethics and economics; peace and development; liberty and prosperity -- these twin beacons must always go together; one is useless without the other') and grounds it in Confucius' fisherman parable, arguing that the goal of governance is not dole-outs but teaching, assisting with tools, providing freedom, and enabling entrepreneurial genius. He validates the thesis across three natural experiments: the US (Edison, Tesla, Ford, Gates, Jobs, contained by FDR/Eisenhower/Obama good governance), China (Deng Xiaoping's One-Country-Two-Systems unleashing Jack Ma's generation), and the Korea comparison (South Korea's private initiative vs. North Korea's 'abject poverty as a result of its tight grip on creativity'). His specifically Filipino proof: OFW engineers, nurses and doctors 'earn more than the average Caucasians' in the US, Canada and Australia and 'observe strict traffic rules simply because these rules are enforced evenly and fairly' -- demonstrating that the problem is governance, not the Filipino character. He notes FLP's programs in Cebu (13 professorial chairs, 20 law scholarships, USC student Tess Marie Tan winning 2nd in the Dissertation Contest) and closes: 'if our Filipino brethren are accorded liberty, prosperity and the rule of law, they will use their entrepreneurial ingenuity to uplift themselves from destitution, disease and disability.'

## Notable Anecdotes

### Anecdote 1

FLP program milestone reported to a Cebu audience: 13 professorial chairs, 20 law scholarships, and USC student Tess Marie Tan winning second place in the FLP Dissertation Contest (behind Rafael Pangalangan of Oxford/UP).

### Anecdote 2

The OFW law-abiding observation: Filipino professionals in the US 'earn more than the average Caucasians' and 'observe strict traffic rules simply because these rules are enforced evenly and fairly' -- the implication being that the dysfunction at home is about governance, not the Filipino character.

### Anecdote 3

The Confucius fisherman unpacked: the goal of governance is 'to provide guarantees and incentives to help the fisherman prosper, to create the institutions to support him, and to promulgate minimal regulations to prevent him from appropriating all the fishing grounds, from keeping all the earnings to himself and from forgetting his obligation to pay reasonable taxes.'
