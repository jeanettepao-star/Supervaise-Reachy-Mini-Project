...
def main() -> int:
    ...
    if existing:
        print(f"Found {len(existing)} existing clips for '{args.speaker}'. "
              f"Next index: {start_index:03d}\n")
    ...
    print()
    print("Three low beeps, then a HIGH beep. Speak the instant you hear the")
    print("high beep -- do not wait. Say it the way a museum visitor would:")
    print("naturally, not carefully. Vary distance, pace and volume between")
    print("takes. Do NOT over-enunciate.")
    print()
